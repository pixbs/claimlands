...
//! describes what the numbers are. All *behaviour* lives in `lands-core`.
//!
...
///
/// Embedded rather than read from disk so that `lands-core` tests, the mobile
