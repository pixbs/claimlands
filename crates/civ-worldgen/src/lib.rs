...
//!
//! `civ-core` never sees a coordinate — it asks spatial questions in graph
//! hops (`civ_core::topology`), so the planet's geometry can change without
...
//!
//! Floating point is allowed in this crate and forbidden in `civ-core`. That
