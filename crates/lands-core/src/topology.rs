//! Tile adjacency — the only spatial knowledge `lands-core` has.
//!
...
//!
//! This keeps `lands-core` free of floating point entirely (see
//! docs/determinism.md) and means `lands-worldgen` can change the planet's
...
///
/// Produced by `lands-worldgen` from the hex sphere, or by hand in tests.
