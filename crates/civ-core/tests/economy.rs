...
use civ_core::economy;
use civ_core::event::Event;
...
fn build_prices_scale_within_the_territory_only() {
    ...
    use civ_core::apply::{build_field_cost, build_town_cost};
...
fn recruit_price_counts_every_unit_kind() {
    ...
    use civ_core::apply::recruit_cost;
...
fn upgrade_price_ignores_pawns() {
    ...
    use civ_core::apply::upgrade_plan;
